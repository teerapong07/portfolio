<section class="py-12 scroll-mt-12" id="skill">
    <h2 class="text-3xl font-bold mb-12 border-b border-purple-600/50 pb-4 inline-block">Technical & Skills</h2>
    <div class="mb-12 bg-gray-800/50 p-6 rounded-lg shadow-lg backdrop-blur-sm">
    ...
    <!-- Tools Section -->
    <div class="mb-6 bg-gray-800/50 p-6 rounded-lg shadow-lg backdrop-blur-sm">
        <div class="flex items-center mb-6">
